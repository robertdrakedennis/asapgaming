            ...
            <div class="card-deck profile-deck">
                <div class="card bg-brand-darker-grey mx-3 my-3">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <h5 class="text-light text-center">Amount Gained</h5>
                ...
                <div class="card bg-brand-darker-grey mx-3 my-3">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <h5 class="text-light text-center">Revenue Gained This Week</h5>
                        <i class="far fa-calendar fa-fw fa-2x text-light py-2"></i>
                        <h6 class="text-light">{{ $revenueThisWeek }}</h6>
                    </div>
                </div>
                <div class="card bg-brand-darker-grey mx-3 my-3">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <h5 class="text-light text-center">Revenue Gained This Month</h5>
                        <i class="far fa-calendar-alt fa-fw fa-2x text-light py-2"></i>
                        <h6 class="text-light">{{ $revenueThisMonth }}</h6>
                    </div>
                </div>
                <div class="card bg-brand-darker-grey mx-3 my-3">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center">
                        <h5 class="text-light text-center">Total Purchases</h5>
